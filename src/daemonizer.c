...
void daemon_start(char *process_name)
{
#ifndef _WIN32
  // Define variables
  pid_t pid, sid;
  ...
  openlog(process_name, LOG_NOWAIT | LOG_PID, LOG_USER);
  syslog(LOG_NOTICE, "Successfully started %s", process_name);
...
void daemon_end(const char *msg)
{
